...
def getprofileonprice(request):
    ...
    if category_id:
        ...
        profiles = UserProfile.objects.filter(price__range = (min_price, max_price))
        category = {
            'category_name': ' Services'
        }
...
def getprofileonrating(request):
    ...
    if category_id:
        ...
        profiles = UserProfile.objects.filter(profile_id__in=profile_ids)
        category = {
            'category_name': ' Services'
        }
...
def getprofileonstate(request):
    ...
    if category_id:
        ...
        profiles = UserProfile.objects.filter(user_id__in=user_id)
        category = {
            'category_name': ' Services'
        }
