...
#     userDetails = User.objects.get(username='Amruta')
    ...
    if pic1:
        ...
        shutil.copy('C:/git/zipcode/Capstone/Code/EventHubApp/static/events/assets/img/media/'+userPic1.name, 'C:/git/zipcode/Capstone/Code/EventHubApp/static/events/assets/img')
    if pic2:
        userPic2 = request.FILES['pic2']
        fs.save(userPic2.name, userPic2)
        profileDetails.pic2 = userPic2.name
        shutil.copy('C:/git/zipcode/Capstone/Code/EventHubApp/static/events/assets/img/media/' + userPic2.name,
                    'C:/git/zipcode/Capstone/Code/EventHubApp/static/events/assets/img')
    if pic3:
        userPic3 = request.FILES['pic3']
        fs.save(userPic3.name, userPic3)
        profileDetails.pic3 = userPic3.name
        shutil.copy('C:/git/zipcode/Capstone/Code/EventHubApp/static/events/assets/img/media/' + userPic3.name,
                    'C:/git/zipcode/Capstone/Code/EventHubApp/static/events/assets/img')
    if pic4:
        userPic4 = request.FILES['pic4']
        fs.save(userPic4.name, userPic4)
        profileDetails.pic4 = userPic4.name
        shutil.copy('C:/git/zipcode/Capstone/Code/EventHubApp/static/events/assets/img/media/' + userPic4.name,
                    'C:/git/zipcode/Capstone/Code/EventHubApp/static/events/assets/img')
    if pic5:
        userPic5 = request.FILES['pic5']
        fs.save(userPic5.name, userPic5)
        profileDetails.pic5 = userPic5.name
        shutil.copy('C:/git/zipcode/Capstone/Code/EventHubApp/static/events/assets/img/media/' + userPic5.name,
                    'C:/git/zipcode/Capstone/Code/EventHubApp/static/events/assets/img')
    ...
    serviceTypes = request.POST.get('stype')
    SPDetails.type = serviceTypes.rstrip(";")

    serviceOffers = request.POST.get('soffer')
    SPDetails.offers = serviceOffers.rstrip(";")

    servicePackages = request.POST.get('spackage')
    SPDetails.package = servicePackages.rstrip(";")
...
def modifyServiceUserProfile(request):
    ...
    if request.POST.get('phone'):
         ...
         userInstance.phone = '+91' + userPhone
...
def updateUserProfileDetails(request):
    ...
    if request.POST.get('stype'):
        serviceTypes = request.POST.get('stype')
        profileDetailsInstance.type = serviceTypes.rstrip(";")
    if request.POST.get('soffer'):
        serviceOffers = request.POST.get('soffer')
        profileDetailsInstance.offers = serviceOffers.rstrip(";")
    if request.POST.get('spackage'):
        servicePackages = request.POST.get('spackage')
        profileDetailsInstance.package = servicePackages.rstrip(";")
    ...
    if pic1:
        ...
        shutil.copy('C:/git/zipcode/Capstone/Code/EventHubApp/static/events/assets/img/media/' + userPic1.name,
                    'C:/git/zipcode/Capstone/Code/EventHubApp/static/events/assets/img')
    if pic2:
        userPic2 = request.FILES['pic2']
        fs.save(userPic2.name, userPic2)
