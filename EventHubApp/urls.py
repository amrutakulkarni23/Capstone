...
#     url(r'^admin/', admin.site.urls),
    ...
    url(r'^signout/$', event_views.signout, name='signout'),
    ...
    url(r'^confirmOrder', event_views.confirmOrder, name='confirmOrder'),
    url(r'^myOrders', event_views.myOrders, name='myOrders'),
    url(r'^sign_in/$', event_views.sign_in, name='sign_in'),
